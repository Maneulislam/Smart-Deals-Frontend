...
const Navbar = () => {
    ...
    const navLinks = (
        ...
        <>
            ...
            <li><NavLink to="/all-products" className={({ isActive }) => isActive ? "text-[#8B5CF6] font-semibold" : "text-gray-600 hover:text-[#8B5CF6]"}>Products</NavLink></li>
                ...
                <div className="navbar-end flex gap-2 md:gap-4">
...

                    {
                        <Link
                            ...
                            className="btn btn-sm btn-outline border-[#8B5CF6] text-[#8B5CF6]"
                        >
                            {user ? "Logout" : "Login"}
                        </Link>
                    }
